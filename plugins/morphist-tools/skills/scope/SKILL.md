...
user-invocable: true
argument-hint: "[--sprint-size=SIZE] [--auto] [--show]"
---
...
Read `.omc/sprint-plan/current/requirements.md`.
...
If `--show`: read and display `current/sprint-scope.md` if it exists. Show the IN/STRETCH/DEFER split. Stop.
...
**Inputs**:
- `current/requirements.md` — all FRs from Phase 1
- `current/discovery.md` — velocity data for sprint N>1
