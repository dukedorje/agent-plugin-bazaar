...
- [x] ADR-006 accepted in `ARCHITECTURE.md` — sibling host, consumes
      ADR-001, ready derived, stack not kernel truth
...
- [x] Fold: materialize `openspec/specs/taskmaster/spec.md` and archive
