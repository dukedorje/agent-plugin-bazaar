...
| How to *use* the verbs | [`plugins/intention/README.md`](../plugins/intention/README.md) — current DAG, run-it-by-me, status ∪ beads |
| Why it is shaped this way | [`ARCHITECTURE.md`](../ARCHITECTURE.md) |
| Hard-won facts | [`LEARNINGS.md`](LEARNINGS.md) |
| Work graph | `/status` (OpenSpec + `bd ready`) · `conductor.py ready` |
